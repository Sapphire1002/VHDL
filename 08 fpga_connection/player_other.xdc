...
set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports {clk_100MHz_in}]
set_property -dict {PACKAGE_PIN F22 IOSTANDARD LVCMOS25} [get_ports {reset}]
set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS25} [get_ports {sw_start}]
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS25} [get_ports {pl1}]
...
set_property -dict {PACKAGE_PIN AB11 IOSTANDARD LVCMOS25} [get_ports {scl_out}]
set_property -dict {PACKAGE_PIN AA7 IOSTANDARD LVCMOS25} [get_ports {reset_out}]
